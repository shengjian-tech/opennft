 ...
 */
package net.shengjian.frame.util.patchca.filter.predefined;

import net.shengjian.frame.util.patchca.filter.AbstractFilterFactory;
import net.shengjian.frame.util.patchca.filter.library.DoubleRippleImageOp;
