...
import net.shengjian.frame.annotation.TableSuffix;
...
public class Fwlog extends BaseEntity {
    ...
    // alias
    /*
     * public static final String TABLE_ALIAS = "Fwlog"; public static final String
     * ALIAS_ID = "ID"; public static final String ALIAS_STARTDATE = "访问时间"; public
     * static final String ALIAS_STRDATE = "访问时间(毫秒)"; public static final String
     * ALIAS_TOMCAT = "Tomcat"; public static final String ALIAS_USERCODE = "登录账号";
     * public static final String ALIAS_USERNAME = "姓名"; public static final String
     * ALIAS_SESSIONID = "sessionId"; public static final String ALIAS_IP = "IP";
     * public static final String ALIAS_FWURL = "访问菜单"; public static final String
     * ALIAS_MENUNAME = "菜单名称"; public static final String ALIAS_ISQX = "是否有权限访问";
     */
    // date formats
    ...
    public Fwlog(java.lang.String id) {
        this.id = id;
    }
    ...
    public String toString() {
        return new StringBuilder().append("ID[").append(getId()).append("],").append("访问时间[").append(getStartDate())
                .append("],").append("访问时间(毫秒)[").append(getStrDate()).append("],").append("Tomcat[")
                .append(getTomcat()).append("],").append("登录账号[").append(getUserCode()).append("],").append("姓名[")
                .append(getUserName()).append("],").append("sessionId[").append(getSessionId()).append("],")
                .append("IP[").append(getIp()).append("],").append("访问菜单[").append(getFwUrl()).append("],")
                .append("菜单名称[").append(getMenuName()).append("],").append("是否有权限访问[").append(getIsqx()).append("],")
                .toString();
    }
